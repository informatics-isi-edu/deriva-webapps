...
import UserControlsGrid from '@isrd-isi-edu/deriva-webapps/src/components/plot/chart-with-effect';

export type ChartWithControlsProps = {
  config: Plot;
};

const ChartWithControls = ({ config }: ChartWithControlsProps): JSX.Element => {
