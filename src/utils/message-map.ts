...
export const noColumnsDefinedAlert = '"trace.x_col", "trace.y_col", and "trace.data_col" are all undefined';
export const xColOnlyAlert = '"trace.y_col" is undefined, both x_col and y_col need to be defined';
export const yColOnlyAlert = '"trace.x_col" is undefined, both x_col and y_col need to be defined';
