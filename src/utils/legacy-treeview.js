...
/* ===== End DOM Setup  ===== */
          ...
          function setupDomElements() {
              ...
              if (urlParams[idParamName]) {
                  ...
                  document.querySelectorAll('.closable-panel').forEach(el => {
                    el.classList.add('open-panel');
                    el.classList.remove('close-panel');
                  });
              } else {
          ...
          function toggleIcon (el) {
              ...
              if (innerClass.includes('fa-chevron-down')) {
                  el.removeClass('fa-chevron-down');
                  el.addClass('fa-chevron-right');
              } else if (innerClass.includes('fa-chevron-right')) {
