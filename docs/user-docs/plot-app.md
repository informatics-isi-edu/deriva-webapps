...
12. `user_controls`: Contains information about each user control (data for the control, default value, etc) 
...
13. `grid_layout_config`: Properties for responsive grid
...
14. `layout`: Layout for each item that will be placed inside the grid
